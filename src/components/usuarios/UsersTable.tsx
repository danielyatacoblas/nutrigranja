...
import { Usuario, UserStatus } from "@/types/database";
...
interface UsersTableProps {
  usuarios: Usuario[];
  handleOpenModal: (usuario?: Usuario) => void;
  handleUpdateStatus: (usuario: Usuario, newStatus: UserStatus) => void;
  exportUsersToCSV: () => void;
  exportUsersToPDF: () => void;
  exportUsersToExcel: () => void;
  handleOpenDeleteModal: (usuario: Usuario) => void;
}
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="mt-2 text-gray-500 text-sm">
        Mostrando {Math.min(startIndex + 1, usuarios.length)} a{" "}
        {Math.min(endIndex, usuarios.length)} de {usuarios.length}{" "}
